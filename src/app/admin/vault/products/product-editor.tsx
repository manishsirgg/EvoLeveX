...
import type { Instructor, VaultBook, VaultCourse, VaultProduct } from '@/lib/admin-vault'
...
export function ProductEditor({ product, book, course, instructors, instructorsError, feedback }: { product: VaultProduct | null; book: VaultBook | null; course: VaultCourse | null; instructors: Instructor[]; instructorsError: boolean; feedback?: string }) {
