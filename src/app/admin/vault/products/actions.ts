...
const keys = ['kind','category_id','name','slug','short_description','description','product_mode','price','cover_image_url','sort_order','seo_title','seo_description','author_name','isbn','page_count','physical_weight_g','preview_text','instructor_id','subtitle','level','duration_minutes','preview_video_url']
