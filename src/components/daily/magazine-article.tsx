...
export function MagazineArticle({ article, blocks, resources, preview = false, viewCount, bookmark, shareUrl }: { article: DailyArticle; blocks: DailyBlock[]; resources: DailyBlockResources; preview?: boolean; viewCount?: number; bookmark?: { authenticated: boolean; saved: boolean }; shareUrl?: string }) {
