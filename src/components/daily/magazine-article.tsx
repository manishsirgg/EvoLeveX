...
export function MagazineArticle({ article, blocks, resources, preview = false, viewCount }: { article: DailyArticle; blocks: DailyBlock[]; resources: DailyBlockResources; preview?: boolean; viewCount?: number }) {
