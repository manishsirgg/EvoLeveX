...
export function MagazineArticle({ article, blocks, resources, preview = false, viewCount, bookmark }: { article: DailyArticle; blocks: DailyBlock[]; resources: DailyBlockResources; preview?: boolean; viewCount?: number; bookmark?: { authenticated: boolean; saved: boolean } }) {
