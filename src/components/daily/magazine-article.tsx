...
export function MagazineArticle({ article, blocks, resources, preview = false, viewCount, like, bookmark, shareUrl, relatedArticles = [] }: { article: DailyArticle; blocks: DailyBlock[]; resources: DailyBlockResources; preview?: boolean; viewCount?: number; like?: { authenticated: boolean; liked: boolean; count: number }; bookmark?: { authenticated: boolean; saved: boolean }; shareUrl?: string; relatedArticles?: DailyArticleSummary[] }) {
